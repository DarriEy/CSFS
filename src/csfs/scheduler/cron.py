...
PROVIDER_TIERS: dict[str, list[str]] = {
    "realtime": [
        ...
        "germany_bw", "germany_bavaria", "italy_piedmont", "italy_emilia",
        "germany_nrw", "italy_tuscany",
        "peru_senamhi", "wmo_whos_plata", "wmo_whos_africa",
        "indonesia_pupr", "philippines_pagasa", "bulgaria_eaemdr",
        "romania_inhga", "italy_ispra_wof",
    ],
    "hourly": [
