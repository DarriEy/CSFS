...
_SEED_STATIONS: list[dict] = [
    ...
    {
        "native_id": "ADHI-CG-0001",
        "name": "CONGO AT BRAZZAVILLE",
        "lat": -4.27,
        "lon": 15.28,
        "country": "CG",
        "river": "CONGO",
    ...
    {
        "native_id": "ADHI-GN-0001",
        "name": "NIGER AT FARANAH",
        "lat": 10.03,
        "lon": -10.75,
        "country": "GN",
        "river": "NIGER",
    ...
    {
        "native_id": "ADHI-MR-0001",
        "name": "SENEGAL AT MATAM",
        "lat": 15.65,
        "lon": -13.25,
        "country": "MR",
        "river": "SENEGAL",
    ...
    {
        "native_id": "ADHI-BF-0001",
        "name": "MOUHOUN AT BOROMO",
        "lat": 11.75,
        "lon": -2.93,
        "country": "BF",
        "river": "MOUHOUN",
    ...
    {
        "native_id": "ADHI-MZ-0001",
        "name": "ZAMBEZI AT TETE",
        "lat": -16.16,
        "lon": 33.59,
        "country": "MZ",
        "river": "ZAMBEZI",
    ...
    {
        "native_id": "ADHI-ZW-0001",
        "name": "ZAMBEZI AT KARIBA",
        "lat": -16.52,
        "lon": 28.80,
        "country": "ZW",
        "river": "ZAMBEZI",
    ...
    {
        "native_id": "ADHI-LS-0001",
        "name": "ORANGE AT MASERU",
        "lat": -29.31,
        "lon": 27.49,
        "country": "LS",
        "river": "ORANGE",
    ...
    # ---- Limpopo basin ----
    {
        "native_id": "ADHI-MZ-0002",
        "name": "LIMPOPO AT CHOKWE",
        "lat": -23.66,
        "lon": 32.98,
        "country": "MZ",
        "river": "LIMPOPO",
    ...
    {
        "native_id": "ADHI-BW-0001",
        "name": "LIMPOPO AT PALAPYE",
        "lat": -22.41,
        "lon": 27.13,
        "country": "BW",
        "river": "LIMPOPO",
    ...
    {
        "native_id": "ADHI-ET-0002",
        "name": "AWASH AT HOMBOLE",
        "lat": 8.38,
        "lon": 38.78,
        "country": "ET",
        "river": "AWASH",
    ...
    # ---- Chari / Lake Chad basin ----
    {
        "native_id": "ADHI-TD-0001",
        "name": "CHARI AT NDJAMENA",
        "lat": 12.12,
        "lon": 15.03,
        "country": "TD",
        "river": "CHARI",
    ...
    {
        "native_id": "ADHI-CM-0001",
        "name": "LOGONE AT BONGOR",
        "lat": 10.28,
        "lon": 15.37,
        "country": "CM",
        "river": "LOGONE",
    ...
    # ---- West African coastal rivers ----
    {
        "native_id": "ADHI-CI-0001",
        "name": "BANDAMA AT BRIMBO",
        "lat": 6.57,
        "lon": -4.97,
        "country": "CI",
        "river": "BANDAMA",
    ...
    {
        "native_id": "ADHI-TG-0001",
        "name": "MONO AT NANGBETO",
        "lat": 7.42,
        "lon": 1.45,
        "country": "TG",
        "river": "MONO",
    ...
    {
        "native_id": "ADHI-SL-0001",
        "name": "ROKEL AT BUMBUNA",
        "lat": 9.05,
        "lon": -11.73,
        "country": "SL",
        "river": "ROKEL",
    ...
    {
        "native_id": "ADHI-LR-0001",
        "name": "ST PAUL AT WHITE PLAINS",
        "lat": 6.45,
        "lon": -10.35,
        "country": "LR",
        "river": "ST PAUL",
    ...
    # ---- Central Africa ----
    {
        "native_id": "ADHI-GA-0001",
        "name": "OGOOUE AT LAMBARENE",
        "lat": -0.70,
        "lon": 10.22,
        "country": "GA",
        "river": "OGOOUE",
    ...
    {
        "native_id": "ADHI-CF-0001",
        "name": "OUBANGUI AT BANGUI",
        "lat": 4.37,
        "lon": 18.58,
        "country": "CF",
        "river": "OUBANGUI",
    ...
    {
        "native_id": "ADHI-MG-0001",
        "name": "BETSIBOKA AT AMBODIROKA",
        "lat": -16.95,
        "lon": 46.98,
        "country": "MG",
        "river": "BETSIBOKA",
    ...
    {
        "native_id": "ADHI-MW-0001",
        "name": "SHIRE AT LIWONDE",
        "lat": -15.07,
        "lon": 35.23,
        "country": "MW",
        "river": "SHIRE",
    ...
    {
        "native_id": "ADHI-NA-0001",
        "name": "OKAVANGO AT RUNDU",
        "lat": -17.93,
        "lon": 19.77,
        "country": "NA",
        "river": "OKAVANGO",
    ...
    {
        "native_id": "ADHI-AO-0001",
        "name": "KWANZA AT CAMBAMBE",
        "lat": -9.75,
        "lon": 14.35,
        "country": "AO",
        "river": "KWANZA",
    ...
    # ---- North Africa ----
    {
        "native_id": "ADHI-DZ-0001",
        "name": "CHELIFF AT KHEMIS MILIANA",
        "lat": 36.26,
        "lon": 2.22,
        "country": "DZ",
        "river": "CHELIFF",
    ...
    {
        "native_id": "ADHI-TN-0001",
        "name": "MEDJERDA AT JENDOUBA",
        "lat": 36.50,
        "lon": 8.78,
        "country": "TN",
        "river": "MEDJERDA",
