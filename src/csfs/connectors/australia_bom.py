"""BOM Water Data Online connector — Australian Bureau of Meteorology."""
...
def _map_quality(code_str: str | None) -> QualityFlag:
    """Map a BOM/KiWIS quality code to a CSFS QualityFlag."""
    if code_str is None:
...
class AustraliaBomConnector(BaseConnector):
    ...
    def _parse_timeseries(
        ...
        for entry in ts_data:
            ...
            quality = _map_quality(str(quality_code) if quality_code is not None else None)
