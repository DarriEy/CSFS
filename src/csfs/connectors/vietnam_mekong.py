...
1. **EIDC catalogue fetch** — attempts to download data from the
   EIDC catalogue entry (document ac5b28ca-e087-4aec-974a-5a9f84b06595).

2. **Local CSV files** — reads downloaded CSV files from a local
