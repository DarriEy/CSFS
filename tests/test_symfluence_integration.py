...
def test_provider_backends_cover_the_native_streamflow_providers():
    ...
    assert set(integration.PROVIDER_BACKENDS) == {
        ...
        "camels_aus", "camels_us", "camels_dk", "camels_gb", "camels_se",
    }
...
def test_observation_capability_table_is_well_formed():
    ...
    assert set(specs) == {"USGS", "WSC", "SMHI", "LAMAH_ICE", "LAMAH_CE", "CAMELS_BR", "CAMELS_DE", "CAMELS_CL", "CAMELS_IND", "CAMELS_CH", "CAMELS_AUS", "CAMELS_US", "CAMELS_DK", "CAMELS_GB", "CAMELS_SE", "CSFS"}
...
class TestCommunityObservationBackend:
    ...
    def test_capabilities_map_the_pure_table(self, tmp_path):
        ...
        assert set(caps) == {"USGS", "WSC", "SMHI", "LAMAH_ICE", "LAMAH_CE", "CAMELS_BR", "CAMELS_DE", "CAMELS_CL", "CAMELS_IND", "CAMELS_CH", "CAMELS_AUS", "CAMELS_US", "CAMELS_DK", "CAMELS_GB", "CAMELS_SE", "CSFS"}
